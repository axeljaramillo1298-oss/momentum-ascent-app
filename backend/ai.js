...
async function selectBestPickWithClaude({ event = {}, candidates = [], historyPicks = [] } = {}) {
  ...
  const systemPrompt = [
    ...
    '{"selected_index":0,"abstain":false,"reasoning":"Explicación breve (2-4 oraciones en español)","confidence_adjustment":0,"final_pick":{"pick":"...","market":"...","confidence":0,"risk_level":"BAJO|MEDIO|ALTO","analysis":"Análisis refinado del pick seleccionado","headline":"Una línea vendible de máx 90 caracteres con el dato más fuerte","disclaimer":"Contenido informativo. No garantiza ganancias."}}',
    ...
    "headline: gancho de UNA línea (máx 90 caracteres) para redes sociales, en español, que abre con el número más contundente del análisis (ej. '8/10 visitas ganadas y el rival cede 4.2 goles por partido'). Sin emojis, sin prometer nada.",
...
async function claudeDecideMarket({ event = {}, gptMarkets = {}, publishedToday = [], stats = {}, historyPicks = [] } = {}) {
  ...
  const systemPrompt = [
    ...
    '{"mercado":"1X2|Goles|BTTS|Handicap|Corners","pick":"pick normal exacto","confianza":65,"riesgo":"BAJO|MEDIO|ALTO","razonamiento":"2-3 oraciones","headline":"gancho de 1 linea max 90 chars que abre con el numero mas fuerte del razonamiento, sin emojis ni promesas","tipo":"segura|moderada|arriesgada","safe_pick":"pick DIFERENTE al normal","safe_mercado":"mercado del safe","safe_confianza":73,"safe_riesgo":"BAJO","safe_razonamiento":"por que es mas facil de acertar"}',
